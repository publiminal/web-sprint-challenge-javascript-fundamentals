...
const zooAnimals = [
  ...
  */
  ...
  console.log(`Request 3: filter`, lowPopulationAnimals(zooAnimals));
 ...
 console.log(`Callbacks step 1`, consume(1,2,testCb));
...
function add(a,b){
  ...
  console.log(`Callbacks step 1`, consume(1,2,add));
...
function multiply(a,b){
  ...
  console.log(`Callbacks step 1`, consume(1,2,multiply));
...
function greeting(firstName, lastName){
  ...
  console.log(`Callbacks step 1`, consume('Andres','Bernal',greeting));
...
/* 🐴🐴🐴 Step 4: Create a new object that uses CuboidMaker 🐴🐴🐴
  ...
  console.log(`Topic 3 Cuboid`, cuboid);
